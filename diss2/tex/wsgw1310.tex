...
\title{What \textit{really} happened in the English Industrial Revolution?} %for 130905 WSGW CSU Fort Collins
...
\begin{frame}
\frametitle{Relevant price ratios induced behavioral changes} %\textit{Source:} Robert Allen (2009)}
\begin{figure}[p!]
%\center
