...
%	I pursue a new approach toward understanding and quantifying the causes and outcome of the English Industrial Revolution. The issues surrounding this most important economic event since the Neolithic Revolution are not settled. I will demonstrate with empirics and historical analysis that England, uniquely and fortuitously, learned how to consume unconstrained fossil energy. This invention yielded an unprecedented positive growth externality for the English macro economy, and eventually for the world. The emergent macro effect resulted from numerous micro-inventions which substituted fossil energy for labour, animal, and other organic power. The demand incentive for these productivity-improving inventions grew from an epoch of rising and spreading incomes.
	
%	I contribute to the questions of what happened, and why, during the English Industrial Revolution. My analysis permits me to freshly address these questions: Why England? Why in the $18^{th}$ century? Why no where else? I design my modelling strategy to reveal whether the usual explanations of this event, the cultural, social, and institutional explanation of English exceptionalism, are sufficient to settle the matter. My hypothesis is they are not, rather that economics, specifically the economics of energy, is the prime mover in the outcome. Yet, they help importantly to explain the long and complex tapestry of social changes that permitted the great English invention of Industrial Capitalism.
...
%	Historically, I document changes dating to the $8^{th}$ and $9^{th}$ century CE Carolingian Renaissance to explain the complex social, cultural, scientific, and economic changes that enabled the miracle revolution of the Industrial Revolution a millennium later. In order to provide a complete and coherent story, I discuss, and include in my model, the European Marriage Pattern (EMP) of the middle and late Middle Ages as a mechanism to explain the increase and diffusion of income and the resulting increase in commodity consumption required to drive demand for the eventual products of the Industrial Revolution. 
	
%	This long period of gradual change motivated the inventor/entrepreneurs of the early modern age to use their cumulating knowledge and skills, increasingly available after Johannes Gutenberg introduced moveable type printing and the printing press, to invent productivity-improving technologies and serve the increasing demand for commodity products. My model includes this series of events.
	
%	Additionally, my model includes England's increasing export trade as a source of external demand, and a likely important addition to growing internal demand, as a further incentive to drive manufacturing productivity.
	
%	The modelling approach I develop applies generally, and suggests follow-on work for other major economies, in both historical and contemporaneous time frames.
...
In this paper, I propose a methodological return to data-informed economic principles to explain the miracle. And I conclude that it was primarily an energy revolution; the English learned how to consume virtually unconstrained amounts of fossil energy. This directly led to modern economic growth for the first time in history.
...
\section{Hypotheses}
The English Industrial Revolution (henceforth EIR) was the first example of modern economic growth.\footnote{Kuznets} There were both macroeconomic and microeconomic forces that were causal. The primary driver of the EIR was an energy consumption revolution. There is limited statistical space for a very few causal institutional or cultural events.	%2

\section{Research approach}
As this is a largely data-driven project, I will first describe the data sources and comment on their limitations.
...
This paper uses largely descriptive statistics of the three data series to describe the EIR. Much of the discussion of results depends on the graphs. I do provide analytic statistics including correlations, sample tests, structural break analyses, Granger causality tests, \footnote{Granger} and a scatterplot of energy consumption and gross domestic product. I also discuss the results in the context of microeconomic and macroeconomic theory.
...
This paper's central assertion is that the EIR was, primarily, an energy revolution. Specifically an energy consumption revolution supported by an energy supply revolution. To support that hypothesis, first I present the data:
...
The Black Death and its aftermath affected the relatively flat economic performance from 1300 to 1500, but set the stage for a growth boom in the period 1500 to 1600. In the period 1600 to 1750 growth in both relatively flattened, and then boomed during the period 1750 to 1873.
...
However, this overall view does hide important dynamics that the data contain. I examine these more subtle results next, and thereby set the stage for telling the story of the EIR.

\subsection{Causality tests}
I continue by using basic statistical causality tests, specifically the Granger bi-variate test. \footnote{Granger} Table \ref{tbl:grangerEnergyGdp} reports this result for the four main eras already identified.

\begin{center}
Table \ref{tbl:grangerEnergyGdp} about here
\end{center}

During the first energy/GDP era Granger causality between energy and GDP runs both ways at significant levels; while not ignoring these results, I do not want to over-interpret what was happening given the huge shocks of the Black Death. However, it is significant for later eras that the Black Death caused wages to rise, and the European Marriage Pattern (EMP) \footnote{Hajnal} increased family incomes entering the early modern period.
...
In the third energy/GDP era of 1600 to 1750, neither direction of causality is significant. This will turn out to have important implications as we build the narrative shortly for the EIR.
...
\begin{center}
Figure \ref{fig:wage-energy} about here \footnote{Allen 2010}
\end{center}
...
While the economics of these ratios may be intuitive, why not appeal to microeconomic theory to help us understand what motivated Desagulier, Newcomen, Watt and all the other founding fathers of the EIR.

Equation \ref{eq:mrp} is a variation on production theory that will be familiar to those who remember their Econ 101. A major topic of production theory is how entrepreneurs maximize profits given the derived demand curves of the various input choices. This equation is a variation on that theme:
...
Label&Examples\\
\hline
English exceptionalists&Landes, McCloskey, Mokyr\\
Partial culturalists&Cipolla, Pomeranz, Allen\\
Primarily energetic&Cottrell, Wrigley, Malanima\\
Thermodynamicists&Georgescu-Roegen, Ayres, Garrett\\
\end{tabular}
\end{table}
...
\begin{figure}[p!]
\center
\caption{Spaghetti energy vs. gdp}
...
\begin{figure}[p!]
\center
\caption{diffs of energy vs. gdp}
...
\begin{figure}[p!]
\center
\caption{Coal and wood energy sources}
\label{fig:woodCoal}
...
\begin{figure}[p!]
\center
\caption{Real wage to energy ratios}
