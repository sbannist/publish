...
supply1 <- x * 2
supply2 <- x * 2
df <- data.frame( x = x, supplyl1=supply1,demand1=demand1,supply2=supply2,demand2=demand2)

ggplot(df, aes(x)) +
  geom_vline(aes(xintercept=10), colour="red",size=2) +
  geom_vline(aes(xintercept=20), colour="red",size=2,linetype=2) +
  geom_line(aes(y=demand2), colour="green",size=2) +
  geom_line(aes(y=demand1), colour="green",size=2,linetype=2) +
  scale_x_continuous(name='Output')+
  scale_y_continuous(name='')+
  labs(title='Energy/GDP era one AD - AS,\n 1300 - 1500')
...
ggplot(df, aes(x)) +
  geom_vline(aes(xintercept=30), colour="red",size=2) +
  geom_vline(aes(xintercept=10), colour="red",size=2,linetype=2) +
  geom_line(aes(y=demand1), colour="green",size=2) +
  geom_line(aes(y=demand2), colour="green",size=2,linetype=2) +
  scale_x_continuous(name='Output')+
  scale_y_continuous(name='')+
  labs(title='Energy/GDP era two AD - AS,\n 1500 - 1600')
...
ggplot(df, aes(x)) +
  geom_vline(aes(xintercept=15), colour="red",size=2) +
  geom_vline(aes(xintercept=30), colour="red",size=2,linetype=2) +
  geom_line(aes(y=demand1), colour="green",size=2) +
#  geom_line(aes(y=demand2), colour="green",size=2,linetype=2) +
  scale_x_continuous(name='Output')+
  scale_y_continuous(name='')+
  labs(title='Energy/GDP era three AD - AS,\n 1600 - 1750')
...
ggplot(df, aes(x)) +
  ...
  scale_x_continuous(name='Output')+
  scale_y_continuous(name='')+
  labs(title='Energy/GDP era four AD - AS,\n 1600 - 1750')
