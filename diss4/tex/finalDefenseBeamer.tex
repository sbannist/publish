...
\title{Economic Development with unlimited supplies of energy: causes and consequences of industrial revolutons} %for 1504 final defense SLC
\author{
Stephen C. Bannister\\
...
My committee:\\
\begin{itemize}
\item[] Dr. Richard Fowles
\item[] Dr. William Carlisle
\item[] Dr. Thomas Maloney
\item[] Dr. Rudi von Arnim
\item[] Dr. Myron Evans
\item[] Dr. Timothy Garrett
\item[] Dr. John Watkins
\end{itemize}
My colleagues, students, and supporting friends\\
\vspace{0.1in}
And the person who is not here \ldots
\end{frame}

\begin{frame}
I dedicate this dissertation to Dr. Stephen Reynolds, who cannot be here with us today
\end{frame}

\begin{frame}{The great energy revolutions}
\begin{itemize}
\item[] Fire -- more efficient human energy inputs -- larger brains
\item[] Agriculture -- surplus
\item[] European sail -- global trade dominance
\item[] Coal -- freedom from constrained heat energy inputs
\item[] Steam -- removing muscle-power energy constraints
\end{itemize}
I will focus on the last two
\end{frame}

\section{Paper one -- ``What really happened in the English Industrial Revolution?''}

\begin{frame}{Paper one -- ``What really happened in the English Industrial Revolution?''}
\begin{itemize}
\item[] Energy and GDP
\item[] Energy consumption patterns
\item[] Wood-to-coal, toward a theory
\item[] Muscle-to-steam, toward a theory
\end{itemize}
\end{frame}

\begin{frame}{Energy and GDP -- one ``data generating process''}
\begin{table}[h!]
\begin{center}
\begin{tabular}{lr}
\hline
...
\label{tbl:cor}
\end{table}
Note that this implies that levels and growth of mean living standards depend on per-capita energy consumption.
\end{frame}
...
\begin{frame}{Towards a theory of organic industrial revolutions}
...
\begin{frame}{Paper two -- ``China -- The empire that did not bark''}
\begin{itemize}
\item[] A natural experiment
\item[] China's institutional sufficiency
\item[] England had what China lacked
\end{itemize}
\end{frame}

\subsection{The institutional case: China's sufficiency (Peer Vries)}
\begin{frame}{The case: China's institutional sufficiency (Peer Vries)}
 ...
 China was "just as little, an 'open society' as Britain was'.''
...
%				\item ``Weber was wrong: Chinese `rationality, work ethos, business acumen, and love of profit' were just as vivid as in Britain.''
				...
				\item Pomeranz and Wong (and others) support this point of view -- essentially saying that Europe had no sufficiently different institutions from China to explain the history.
...
\frametitle{The microeconomics of energy source substitution} 	
 		\begin{figure}
		\centerline{
		\mbox{\includegraphics[width=0.39\textwidth]{C:/Users/Steve/Documents/GitHub/publish/1310utahSoc/images/gworldwages.png}}
		\mbox{\includegraphics[width=0.39\textwidth]{C:/Users/Steve/Documents/GitHub/publish/1310utahSoc/images/gworldenergycost.png}}
		\mbox{\includegraphics[width=0.39\textwidth]{C:/Users/Steve/Documents/GitHub/publish/1310utahSoc/images/wage-energy.png}}
		}
...
\begin{frame}{Paper three -- ``The rise and fall of industrial capitalism''}
\begin{itemize}
\item[] Whence industrial capitalism?
\item[] Derived demand for capital elicited supply
\item[] Accumulation drove the institution
\item[] The fall will be cause by a decline in aggregate demand
\end{itemize}
\end{frame}

\begin{frame}{Towards a theory of industrial capitalism}
All energy revolutions arose in a context of sufficient, ever increasing, effective aggregate demand.\\ \vspace*{0.1in}
First energy revolutions -- wood to coal -- were necessary for industrial capitalism, but not sufficient.\\ 		\vspace*{0.1in}
...
\section{Whence demand support?}

\begin{frame}{Whence rising aggregate demand?}
 		\begin{figure}[h!]
		\centerline{
		\mbox{\includegraphics[width=0.50\textwidth]{logPop1-2014.jpg}}
		\mbox{\includegraphics[width=0.50\textwidth]{logDiffPop1-2014.jpg}}
		}
		\caption{Angus Maddison and UN: log and log differences of global population levels}
		\label{fig:logPopLevel}
		\end{figure}
\end{frame}

\begin{frame}{John Nef -- the coal question}
...
\begin{frame}{Paul Mantoux -- the steam question}
Mantoux, in ``The Industrial Revolution in the Eighteenth Century'' details with rich anecdotes the rise of machine industry -- the replacement of muscle with steam power in highly centralized factories -- and the demand for tangible capital investments that resulted.\\
		\vspace*{0.1in}
As in Nef's story, capital supply was from wealthy merchants and landowners, and does not seem to have been a constraint.		
\end{frame}


\begin{frame}{John Hartwell -- The ``natural experiment'' of Sung China}
...
%\begin{frame}{A story of the Industrial Revolution and industrial capitalism}
%Rising population causes rising effective aggregate demand.\\ \vspace*{0.05in}
%Merchants become wealthy as production for markets and urbanization rise. Their direct capital needs are low, so they accumulate and invest %elsewhere.\\ \vspace*{0.05in}
...
%In England, this coal infrastructure investment feeds the second half of the revolution, the steam revolution, demanding ever more tangible %investment. The demand for steam power arises from high English wages and low English energy prices.\\ \vspace*{0.05in}
%Capital supply arises from wealthy merchant capitalists, wealthy land holders, and eventually a banking system.
%\end{frame}
...
\begin{frame}{Summarizing}
Rising population causes rising effective aggregate demand and deforestation.\\ \vspace*{0.05in}
Demand begets supply,\\
elicits endogenous technology, energy revolutions, and institutions,\\
causes a rise in demand for, and supply of, tangible capital, \\
and leads to, with accumulation, industrial capitalism.\\ \vspace*{0.05in}
The lifting of energy constraints raises productivity and living standards.\\ \vspace*{0.05in}	
The Big Question for political economists:
If population-driven rising aggregate demand ``caused'' the Industrial Revolution and elicited industrial capitalism, will population-driven falling aggregate demand cause the demise of industrial capitalism?
\end{frame}
