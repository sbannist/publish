% use new file for base, paper1, paper2
% leave other files the same unless specifically need to edit, 
...
%%%% changes for Edit One 9/7/15
\usepackage[total={6.0in,8.5in}, includehead,
...
\chairtitle{Professor} \submitdate{December 2015} \copyrightyear{2015}
...
%-----------------------------------------------------------------------------------
\maintext
\include{scbEditOneintropaper}
\include{scbEditOnepaper1}
\include{scbEditOnepaper2}
%\vspace*{-21pt}
...
%\iffalse
%commented out to try to fix spacing 9/9/15 scb
\numberofappendices=2
\appendix
%\fi
...
%\providecommand\chaptername{Appendix}
\include{scbappendix1}
%%% so does not pick sections and below
